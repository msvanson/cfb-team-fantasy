...
import { sendAutomationFailureAlert } from './automation-alerts';
export const AUTOMATION_JOBS = {
  ...
  weekly_recaps: {
    name: 'Weekly Recap Drafts',
    description: 'Finalizes completed fantasy weeks and generates commissioner review drafts.',
    schedule: 'Monday at 5:15 AM Eastern',
    staleAfterHours: 192
  }
};
  ...
  try {
    ...
    if (failed) {
      await sendAutomationFailureAlert({
        jobKey,
        jobName: AUTOMATION_JOBS[jobKey].name,
        triggerSource,
