...
const alias={
 ...
 'louisiana monroe':'ulm','ul monroe':'ulm','florida international':'fiu','north carolina state':'nc state','miami hurricanes':'miami','hawai i rainbow warriors':'hawaii','hawai i':'hawaii'
};
