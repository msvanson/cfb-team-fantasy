...
Staging migration is applied and verified successfully. Next we’ll add the secure route that allows each signed-in account to update only its assigned roster and theme.

### Identity edit 2 — Secure preferences API

Create this new file on `Develop`:

**File:** `app/api/account/preferences/route.js`  
**Estimated lines:** 1–185
